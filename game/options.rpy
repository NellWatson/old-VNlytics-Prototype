...
init -1 python hide:
    ...
    config.window_title = u"VNlytics Prototype"
...
python early:
    config.save_directory = "Telemetry Prototype-1467631251"
...
init python:
    ...
    build.directory_name = "VNlytics-Prototype-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "VNlytics-Prototype"
